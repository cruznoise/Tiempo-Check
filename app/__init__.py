...
def create_app(config_object=None):
    ...
    app.register_blueprint(app_base_bp)                  # sin prefijo
    ...
    if should_start and is_main and app.extensions.get("scheduler") is None:
        ...
        print(f"[SCHED][BOOT] ENABLE_SCHEDULER=1 tz={tz} usuario_id={usuario_id}")
        try:
            sched = start_scheduler(app, usuario_id=usuario_id, tz=tz)
